package com.johnsison.document.controllers;
...
import com.johnsison.document.repos.DocumentRepository;
...
public class DocumentController {
	...
	public StreamingResponseBody download(@RequestParam("id") long id,
